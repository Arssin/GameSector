      ...
      <Container size="md">
        ...
        >
          <Text size="xs" c="dimmed" ta="left" style={{ margin: "0 auto", lineHeight: 1.6 }}>
            <strong>Disclaimer:</strong> This is a demonstration project showcasing programming skills and is not a real gambling platform. All games are simulated and do not involve real money or monetary transactions. This application is intended
            for educational and portfolio purposes only.
          </Text>

          <Text size="xs" c="dimmed" ta="left" style={{ margin: "0 auto", lineHeight: 1.6 }}>
            <strong>Responsible Gaming Warning:</strong> Gambling can be addictive and may lead to financial difficulties. This demonstration is not intended to promote or encourage gambling activities. If you or someone you know has a gambling
            problem, please seek help by contacting appropriate support services in your area.
          </Text>

          <Text size="xs" c="dimmed" ta="left" style={{ margin: "0 auto", lineHeight: 1.6 }}>
            <strong>Legal Notice:</strong> The games and content presented here are for demonstration purposes only and are protected by intellectual property rights. Any resemblance to real gambling products or services is purely coincidental. Users
            must be of legal age to view gambling-related content in their jurisdiction.
          </Text>
